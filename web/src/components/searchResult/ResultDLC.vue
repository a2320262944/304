<template>
  <div>
<!-- set heading style -->
      <h4 style="color:red"><u><b>SEARCH RESULT - BY AWARD</b></u></h4>
        <div class="row">
...
<!-- set table header and column width -->
              <th scope="col" style="width: 5%"><u>E3</u></th>
              ...
              <th scope="col" style="width: 10%"><u>DLC</u></th>
              <th scope="col" style="width: 14%"><u>CD</u></th>                                   
            </font></tr>
            </thead>
            <tbody>
<!-- set table data -->
...
<script>
  export default {
    ...
    created() {      
      let uri = `http://localhost:3000/api/searchDLC/${this.$route.params.DLC}`;
